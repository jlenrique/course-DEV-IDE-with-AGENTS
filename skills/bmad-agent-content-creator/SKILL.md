...
| CP | Cluster planning (Pass 1) — full cluster planning workflow: evaluate slides, select heads, generate interstitial briefs, assign arcs and master behavioral intent, plan bridges, populate cluster manifest fields | Load `./references/cluster-decision-criteria.md`, `./references/interstitial-brief-specification.md`, `./references/cluster-narrative-arc-schema.md`, `./references/cluster-density-controls.md` |
