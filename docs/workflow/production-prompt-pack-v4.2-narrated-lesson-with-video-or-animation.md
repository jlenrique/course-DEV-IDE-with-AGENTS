...
Required artifacts written by this step:
- `[BUNDLE_PATH]/ingestion-quality-gate-receipt.md` (generated by emit_ingestion_quality_receipt.py)
...
- Run: `Get-ChildItem [BUNDLE_PATH] -File | Measure-Object | Select-Object -ExpandProperty Count`
- Expected files: `run-constants.yaml`, `preflight-results.json`, `operator-directives.md`, `extracted.md`, `metadata.json`, `ingestion-evidence.md`, `ingestion-quality-gate-receipt.md`, `irene-packet.md`
- If count < 8, halt and list missing files. Do not report checkpoint PASS until count is verified.
