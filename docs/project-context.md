...
- [ ] Epic 3: Core Tool Specialist Agents & Mastery Skills (9 stories — Story 3.1 Gary/Gamma DONE, re-sequenced: 3.2 Content Creator + QR, 3.3 Kling Video NEW, 3.4 ElevenLabs expanded, 3.5 Canvas, 3.6 Qualtrics, 3.7 Canva manual-tool pattern, 3.8 Source Wrangler, 3.9 Tech Spec Wrangler)
