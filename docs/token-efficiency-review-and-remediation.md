...
- [ ] **Anti-drift doc sync audit:** Ensure `trial-run-prompts-to-irene-pass2-v4.md`, `trial-run-pass2-artifacts-contract.md`, `fidelity-gate-map.md`, and operator cards/checklists are aligned on Gate 6B and Storyboard A/B checkpoints.
