...
You are the acceptance auditor. Review the diff below, the spec, and the context docs listed in the spec frontmatter. Identify any deviations from acceptance criteria, constraints, or governance rules. Report findings as a list with file and line references when possible.

Spec: _bmad-output/implementation-artifacts/spec-elevenlabs-audio-buffer-padding.md
