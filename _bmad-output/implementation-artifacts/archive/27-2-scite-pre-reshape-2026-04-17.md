# ARCHIVED — Pre-Reshape Snapshot of Story 27-2 (2026-04-17)

> **Status:** SUPERSEDED. This file is a frozen snapshot of the pre-reshape 382-line expansion of Story 27-2 (authored 2026-04-17 22:45, archived 2026-04-18 during party-mode green-light round).
>
> **Active dev target:** [_bmad-output/implementation-artifacts/27-2-scite-ai-provider.md](../27-2-scite-ai-provider.md) — re-expanded against the Shape 3-Disciplined 27-0 contract.
>
> **Why it's here:** Paige's green-light SHOULD-FIX — "compress aggressively; full historical block off the active spec" — preserves traceability without polluting the dev target with obsolete ACs. Consult this snapshot only for (a) scite-specific domain knowledge (MCP catalog shapes, smart-citation metadata, paywall semantics, pre-reshape error taxonomy) that informed the reshape, or (b) original ratification party-input.
>
> **Do NOT follow this content for implementation.** The active spec's ACs are authoritative.

---

# [ARCHIVED] Story 27.2: scite.ai Provider
